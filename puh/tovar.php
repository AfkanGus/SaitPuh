...
// Функция формирования SQL-запросов  на добаление
function getQuery()
{
    ...
    for ($i=1;$i<=10;$i++)
    {
        ...
        if ($_GET[$tmp])
        {
            // Значение текущего параметра - колличество товара
            $kol = $_GET[$tmp];
            // Строка запроса
...
// Выполнение операций с баздой данных MySQL
function runMySQL()
{
...
if ($_GET)
{
    ...
    // Флог проверки данных в GET-запросе
    $flag = false;
